                                    ...
                                    <?php
                                        ...
                                        echo '
                                            <div class="alert alert-success">
                                                ...
                                                <li>Vous pouvez imprimer le reçu de paiement en cliquant sur <a href="bondepaiementfournisseur.php?paiement='.$idpaie.'" class="js-open-print" data-title="Reçu de paiement"><i class="fa fa-file-pdf-o"></i> Reçu de paiement</a>.</li>
                                            </div>
                                            ';
                                                }
                                        if ($errors==3) {
                                            ...
                                            echo '
                                                <div class="alert alert-danger">
                                                    ...
                                                    <li>Ce paiement à été déjà effectuée</li>
                                                     <li>Vous pouvez réimprimer le reçu de paiement en cliquant sur <a href="bondepaiementfournisseur.php?paiement='.$idpaie.'" class="js-open-print" data-title="Reçu de paiement"><i class="fa fa-file-pdf-o"></i> Reçu de paiement</a>.</li>
                                                </div>
                                                ';}
                                    echo '
