...
session_start();
	...
	include('../PUBLIC/connect.php');
	 $reponse1 = $bdd->prepare('SELECT * FROM paiements WHERE types=? AND remboursement=0 AND MONTH(datepaiement)=? AND YEAR(datepaiement)=?');
                    ...
                    <div class="col-md-12">
						<section class="panel panel-transparent">
							...
							<header class="panel panel-transparent">
								<h4 class="panel-title">Prestation mensuelle du mois de <?php setlocale(LC_TIME, 'fr_FR.UTF-8'); echo strftime("%b").' '.date("Y");?>
                                </h4>
							</header>
							<?php
