...
session_start();
    ...
    function nombrejour($nom){ 
        { include('../PUBLIC/connect.php');
            ...
            $reponse1 = $bdd->prepare('SELECT * FROM affectations WHERE status=4  AND type=? AND YEAR(datetraitement)=? AND id_service="'.$id_service.'"');
						...
						<section class="panel panel-transparent">
							<div class="row">
								<header class="panel panel-transparent">
									<h4 class="panel-title">Prestation annuelle <?php echo date("Y");?> du service</h4>
								</header>
								<?php
