				...
				<section role="main" class="content-body">
							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										<h2 class="card-title">Ma liste de demande de validation</h2>
									</header>
									<div class="card-body">
                    <?php 
                      if ($errors==2) {
                    ...
                    ?>
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
											<?php
                                                $reponse1 = $bdd->prepare('SELECT * FROM depenses ORDER BY id_depense');
                                                $reponse1 -> execute();
                                                while ($donnees1 = $reponse1->fetch())
                                                    ...
                                                    <td><button class="btn btn-sm btn-success">Autorisé</button>
                                                    </tr>';
                                                    }
                                                    if ($status==0) {
                                                    echo' <tr>
