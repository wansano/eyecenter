...
session_start();
    ...
    function nombrejour($nom){ 
        { include('../PUBLIC/connect.php');
            ...
            $reponse1 = $bdd->prepare('SELECT * FROM affectations WHERE status=4 AND id_service="'.$id_service.'" AND type=? AND datetraitement="'.date('Y-m-d').'"');
						...
						<section class="panel panel-transparent">
							<div class="row">
								<header class="panel panel-transparent">
									<h4 class="panel-title">Prestation du jour du service.</h4>
								</header>
								<?php
