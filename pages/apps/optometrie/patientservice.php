...
$errors = 0; // 0=normal,1=erreur SQL,7=erreur remboursement,8=remboursement OK,2=acceptation OK
...
try {
        if (isset($_POST['accepter']) && isset($_POST['traitement'])) {
            ...
            // Déterminer la page cible (optométrie: mesure par défaut)
            ...
            // Mettre à jour le statut (2 = en cours)
        ...
        if (isset($_POST['remboursement'])) {
            ...
            try {
                ...
                error_log('Erreur remboursement optométrie: ' . $ex->getMessage());
                $errors = 7;
            }
        }
                      ...
                      <?php
                          try {
                                                            $stmt = $bdd->prepare('SELECT a.*, p.age as patient_age, t.operation as traitement_operation
                                                                ...
                                                                WHERE t.id_organigramme IN (2) AND a.status IN (1,2,7)
