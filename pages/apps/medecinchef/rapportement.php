...
try {
    ...
    if (isset($_POST['consulter']) && !empty($_POST['rapport'])) {
        ...
        if ($existe == 0) {
            ...
            try {
                insertRapportement($bdd, $id_patient, $type, $affectation, $_POST);
        ...
        <div class="inner-wrapper">
            <section role="main" class="content-body">
                <header class="page-header">
                    <h2> Rapport medical du patient</h2>
                </header>
                    ...
                    <section class="card">
                            ...
                            <?php
                                        ...
                                        echo '
                                            ...
                                            <strong>Rapport medical du patient '.nom_patient($id_patient).' validé avec succès </strong> <br/> 
