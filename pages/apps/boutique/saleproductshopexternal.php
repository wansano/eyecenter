...
function modelproduit($nom) {
    global $bdd;
    $reponse1 = $bdd->prepare('SELECT model FROM model_produits WHERE id_model=?');
    $reponse1->execute([$nom]);
    return $reponse1->fetchColumn() ?: '';
}

function prixunitaire($nom) {
    global $bdd;
    $reponse1 = $bdd->prepare('SELECT prix_unitaire FROM approvisionnements WHERE no_livraison=?');
    $reponse1->execute([$nom]);
    return $reponse1->fetchColumn() ?: '';
}
								...
								<div class="card-body">
                                    ...
                                    <form class="form-horizontal" novalidate="novalidate" method="POST" action="saleproductshopexternal.php?client=<?php echo $_GET['client'].'&affectation='.$_GET['affectation']?>" enctype="multipart/form-data">
                                        ...
                                        <div class="row form-group pb-3">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="productSelect">Catégorie de produit</label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Opticien</label>
