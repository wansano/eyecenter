                    ...
                    <section class="card">
                        <div class="card-body">
                                        ...
                                        if ($errors==4) {
                                            ...
                                            echo '
                                                <div class="alert alert-danger">
                                                    ...
                                                    <li>Ce '.model($type).' a déjà été approuvé ou veuillez vérifier les informations requises à fournir. Il est également possible <a href="traitementdata.php?affectation='.$affectation.'" target="_blank">d\'imprimer les données</a></li>
                                                </div>
                                                ';}
                                    ?>
                            </div>
                            ...
                            <footer class="card-footer text-end">
                                <button class="btn btn-primary" type="submit" name="ajouter">Valider le soins</button>
                            </footer>
                        </form>
        ...
        <?php if ($errors == 4 && $affectation): ?>
            <script>
                window.onload = function() {
                    window.open('imprimer_soins.php?affectation=<?= $affectation ?>', '_blank');
                };
            </script>
        <?php endif; ?>
