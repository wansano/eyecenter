...
<body>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" class="btn btn-primary" id="btnModifierPatient">Modifier les informations</a>
                </div>
            </div>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const btnEdit = document.getElementById('btnModifierPatient');
            ...
            try {
                ...
                if (!data || !data.success || !data.patient) {
                    ...
                    if (btnEdit) {
                        ...
                        btnEdit.href = 'editpatient.php?ep=default&id_patient=' + encodeURIComponent(pid);
                    }
                }
